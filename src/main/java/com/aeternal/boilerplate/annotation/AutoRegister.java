 ...
 *
 * Can be processed at runtime via AnnotationScanner (using Forge's ModFileScanData)
 ...
 * but this is useful for custom patterns like auto-discovering integration modules
