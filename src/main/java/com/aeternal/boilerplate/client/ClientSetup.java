package com.aeternal.boilerplate.client;
 ...
 */
@Mod.EventBusSubscriber(modid = Boilerplate.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class ClientSetup {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        Boilerplate.LOGGER.info("{} client setup", Boilerplate.MOD_ID);
