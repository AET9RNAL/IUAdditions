...
import com.aeternal.iuadditions.integration.divinerpg.tile.TileArcanaSolarPanel;
...
public class TileEntityArcanaSolarPanelRender<T extends TileArcanaSolarPanel> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(
            @Nonnull TileArcanaSolarPanel te,
            double x,
            double y,
            double z,
            float partialTicks,
