...
import com.aeternal.iuadditions.integration.divinerpg.tile.TileVetheaSolarPanel;
...
public class TileEntityVetheaSolarPanelRender<T extends TileVetheaSolarPanel> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(
            @Nonnull TileVetheaSolarPanel te,
            double x,
            double y,
            double z,
            float partialTicks,
