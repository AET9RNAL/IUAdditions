...
public class TileSkythernSolarPanel extends TileSolarPanel {

    public TileSkythernSolarPanel() {
        super(11, Config.skythernGenDay * 1, Config.skythernOutput * 1,
                Config.skythernStorage * 1, null
        );
    }
    ...
    public ItemStack getPickBlock(final EntityPlayer player, final RayTraceResult target) {
        return new ItemStack(Item.getItemFromBlock(DivinerpgIntegration.blockDivineSolarPanel), 1, BlockDivineSolarPanel.skythern_solar_panel.getId());
    }
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockDivineSolarPanel.skythern_solar_panel;
    }
