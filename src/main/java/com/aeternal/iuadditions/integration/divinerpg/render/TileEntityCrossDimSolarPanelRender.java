...
import com.aeternal.iuadditions.integration.divinerpg.tile.TileCrossDimentionalSolarPanel;
...
public class TileEntityCrossDimSolarPanelRender<T extends TileCrossDimentionalSolarPanel> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(
            @Nonnull TileCrossDimentionalSolarPanel te,
            double x,
            double y,
            double z,
            float partialTicks,
