...
import com.aeternal.iuadditions.integration.divinerpg.tile.TileApalachiaSolarPanel;
...
public class TileEntityApalachiaSolarPanelRender<T extends TileApalachiaSolarPanel> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(
            @Nonnull TileApalachiaSolarPanel te,
            double x,
            double y,
            double z,
            float partialTicks,
