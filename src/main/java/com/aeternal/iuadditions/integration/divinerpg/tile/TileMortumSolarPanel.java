...
public class TileMortumSolarPanel extends TileSolarPanel {

    public TileMortumSolarPanel() {
        super(12, Config.mortumGenDay * 1, Config.mortumOutput * 1,
                Config.mortumStorage * 1, null
        );
    }
    ...
    public ItemStack getPickBlock(final EntityPlayer player, final RayTraceResult target) {
        return new ItemStack(Item.getItemFromBlock(DivinerpgIntegration.blockDivineSolarPanel), 1, BlockDivineSolarPanel.mortum_solar_panel.getId());
    }
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockDivineSolarPanel.mortum_solar_panel;
    }
