...
import com.aeternal.iuadditions.integration.divinerpg.tile.TileSkythernSolarPanel;
...
public class TileEntitySkythernSolarPanelRender<T extends TileSkythernSolarPanel> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(
            @Nonnull TileSkythernSolarPanel te,
            double x,
            double y,
            double z,
            float partialTicks,
