...
public class TileEntityDimSolarPanelRender<T extends TileDimstarlightcollectorSolarPanel> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(
            @Nonnull TileDimstarlightcollectorSolarPanel te,
            double x,
            double y,
            double z,
            float partialTicks,
