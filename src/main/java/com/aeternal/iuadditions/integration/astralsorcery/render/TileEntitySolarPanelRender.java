...
public class TileEntitySolarPanelRender<T extends TileBrightstarlightcollectorSolarPanel> extends TileEntitySpecialRenderer<T> {
    ...
    public void render(
            @Nonnull TileBrightstarlightcollectorSolarPanel te,
            double x,
            double y,
            double z,
            float partialTicks,
