...
package com.aeternal.iuadditions.integration.astralsorcery.block;
...
public enum BlockAstralSolarPanel implements IMultiTileBlock {
    ...
    BlockAstralSolarPanel(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {
    ...
    public static BlockAstralSolarPanel getFromID(final int ID) {
        return values()[ID % values().length];
    }

    public void buildDummies() {
        for (final BlockAstralSolarPanel block : values()) {
