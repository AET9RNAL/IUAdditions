...
package com.aeternal.iuadditions.integration.astralsorcery.recipes;
...
import com.aeternal.iuadditions.api.recipe.RecipeHelper;
import com.aeternal.iuadditions.integration.astralsorcery.AstralSorceryIntegration;
import com.aeternal.iuadditions.integration.astralsorcery.asadditions.recipes.ASARecipes;
...
public class ASRecipes {
    ...
    public static void InitConstellationRecipes(){
        ...
        Item coreStellar = new ItemStack(IUAItem.astralElements, 1, AstralCraftingElements.AstralCraftingElementsTypes.core.getId()).getItem();
        ItemStack iridiumReinforcedAS = new ItemStack(IUAItem.astralElements, 1, AstralCraftingElements.AstralCraftingElementsTypes.reinforced_iridium.getId());
        ItemStack iridiumDenseAS = new ItemStack(IUAItem.astralElements, 1, AstralCraftingElements.AstralCraftingElementsTypes.dense_reinforced_iridium.getId());
        ItemStack iridiumAdvancedAS = new ItemStack(IUAItem.astralElements, 1, AstralCraftingElements.AstralCraftingElementsTypes.iridium_advanced.getId());
        ...
        Item circuitStellar = new ItemStack(IUAItem.astralElements, 1, AstralCraftingElements.AstralCraftingElementsTypes.circuit.getId()).getItem();
