...
public class ASRecipes {
    ...
    public static void InitConstellationRecipes(){
        ...
        Item coreStellar = new ItemStack(IUAItem.astralElements,1,9).getItem();
        Item iridiumReinforcedAS = new ItemStack(IUAItem.astralElements,1,2).getItem();
        Item iridiumDenseAS = new ItemStack(IUAItem.astralElements,1,3).getItem();
        Item iridiumAdvancedAS = new ItemStack(IUAItem.astralElements,1,4).getItem();
        ...
        Item circuitStellar = new ItemStack(IUAItem.astralElements,1,8).getItem();
