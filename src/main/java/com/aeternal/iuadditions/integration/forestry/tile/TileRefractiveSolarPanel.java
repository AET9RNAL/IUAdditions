...
public class TileRefractiveSolarPanel extends TileSolarPanel {

    public TileRefractiveSolarPanel() {
        super(14, Config.refractivebeekeeperGenDay * 1, Config.refractivebeekeeperOutput * 1,
                Config.refractivebeekeeperStorage * 1, null
        );
    }
    ...
    public ItemStack getPickBlock(final EntityPlayer player, final RayTraceResult target) {
        return new ItemStack(Item.getItemFromBlock(ForestryIntegration.blockForestrySolarPanel), 1, BlockForestrySolarPanel.refractivebeekeeper_solar_panel.getId());
    }
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockForestrySolarPanel.refractivebeekeeper_solar_panel;
    }
