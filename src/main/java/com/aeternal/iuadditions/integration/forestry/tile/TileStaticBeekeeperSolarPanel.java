...
public class TileStaticBeekeeperSolarPanel extends TileSolarPanel {

    public TileStaticBeekeeperSolarPanel() {
        super(11, Config.staticbeekeeperGenDay * 1, Config.staticbeekeeperOutput * 1,
                Config.staticbeekeeperStorage * 1, null
        );
    }
    ...
    public ItemStack getPickBlock(final EntityPlayer player, final RayTraceResult target) {
        return new ItemStack(Item.getItemFromBlock(ForestryIntegration.blockForestrySolarPanel), 1, BlockForestrySolarPanel.staticbeekeeper_solar_panel.getId());
    }
    ...
    public IMultiTileBlock getTeBlock() {
        return BlockForestrySolarPanel.staticbeekeeper_solar_panel;
    }
