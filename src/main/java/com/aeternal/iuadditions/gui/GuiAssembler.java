package com.aeternal.iuadditions.gui;
...
public class GuiAssembler  extends GuiIU<ContainerAssembler> {

    public final ContainerAssembler container;

    public GuiAssembler(ContainerAssembler container1) {
        super(container1);
    ...
    private void handleUpgradeTooltip(int mouseX, int mouseY) {
        if (mouseX >= 3 && mouseX <= 15 && mouseY >= 3 && mouseY <= 15) {
            ...
            text.add(Localization.translate("iu.blast_furnace_recipe.info")); //TODO
